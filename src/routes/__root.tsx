...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Rokesh V — CSE undergrad building AI, full-stack and Android applications. Chennai, India." },
      { name: "author", content: "Rokesh V" },
      { property: "og:title", content: "Rokesh V — Software Engineer & Full-Stack Developer" },
